module.exports = async client => {
  ...
  client.user.setActivity(`in the ${ordinal.toOrdinal(numb)} timeline. Use ${client.config.prefix}help. ` + client.guilds.size + " guilds." , "Hi.", "https://www.roblox.com/My/Groups.aspx?gid=3643510", "PLAYING")
